...
public class ObjectManager : MonoBehaviour
{
    ...
    {
        GameObject cube=(GameObject)Resources.Load("Cube(restore)");
        ...
        GameObject FinishedObject=new GameObject("emptyObject");
        FinishedObject.transform.position=finish_pro;
        for(int i=0;i<list_pos.Count;i++)
        {
            ...
            obj.transform.parent=FinishedObject.transform;
